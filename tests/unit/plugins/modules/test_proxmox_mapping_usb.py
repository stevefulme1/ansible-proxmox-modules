...
"""Tests for proxmox_mapping_usb module."""
...
MODULE_PATH = (
    "ansible_collections.stevefulme1.proxmox.plugins.modules.proxmox_mapping_usb"
)
MODULE_UTILS_PATH = (
...
class TestCreate:
    ...
    def test_create_basic(self, mock_api_cls, module_args):
        ...
        module_args.update(state="present", name="test-usb")
...
class TestDelete:
    ...
    def test_delete_basic(self, mock_api_cls, module_args):
        ...
        module_args.update(state="absent", name="test-usb")
        set_module_args(module_args)
        rc = _run_module()
        assert rc == 0
